...
<div class="row">
	...
	<form id="addsize" action="addsize" method="POST">
	...
	<div class="table-responsive text-nowrap">
		<table class="table">
			...
			<tbody class="table-border-bottom-0">
				...
				<c:forEach items="${sizelit}" var="psize">



					<tr>

						<td class="${psize.stt}">${psize.stt}</td>
						<td class="${psize.stt}">${psize.parentCategoryName}</td>
						<td class="${psize.stt}">${psize.sizeName}</td>
						<td class="${psize.stt}">${psize.createDate}</td>
							...
							<div class="dropdown">
								...
								<div class="dropdown-menu">
									<a class="dropdown-item " data-bs-toggle="modal"
										...
										onclick="myJsFuncSize(${psize.sizeID}, '${psize.sizeName}');"><i
										class="bx bx-edit-alt me-2"></i> Edit</a> <a class="dropdown-item"
										data-bs-toggle="modal" data-bs-target="#modalCenter"
										onclick="myJsFuncDeleteSize(${psize.sizeID}, '${psize.sizeName}');"
							...
							<div class="row">
								<div class="col mb-3">
									<label for="nameBasic" class="form-label">Name</label> <input
										type="text" id="oldName" name="sizeName" class="form-control"
				...
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="row">
								<div class="col mb-3">
									<input type="hidden" id="sizeId1" name="sizeId"
										class="form-control" placeholder="Enter Name" />
								</div>
							</div>
