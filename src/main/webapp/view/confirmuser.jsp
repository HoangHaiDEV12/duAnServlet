			...
			<div class="card">
				<div class="card-body">
					...
					<c:if test="${not empty user}">
						<h2>Bạn có phải là : </h2>
						<h3 style="color: red"> ${user.fullName}</h3>
					</c:if>
					...
					<div class="mb-3">
								...
								<c:if test="${ empty error}">
									<a href="/com.tulamweb/recover" class="btn btn-primary d-grid w-100" type="submit">Không phải</a>
								</c:if>	
								<c:if test="${not empty error}">
									<a href="/com.tulamweb/recover" class="btn btn-primary d-grid w-100" type="submit">Trở Lại</a>
								</c:if>	
						</div>
