			...
			<div class="card">
				<div class="card-body">
					...
					<form id="formAuthentication" class="mb-3" action="login"
						method="post">
						<div class="mb-3">
							<label for="email" class="form-label">Số Điện Thoại hoặc
								Tên Đăng Nhập</label> <input type="text" class="form-control"
								id="userName" name="userName"
								placeholder="Nhập số điện thoại hoặc tên đăng nhập" autofocus />
						</div>
						<div class="mb-3 form-password-toggle">
							<div class="d-flex justify-content-between">
								<label class="form-label" for="password">Mật Khẩu</label> <a
									href="/com.tulamweb/recover"> <small>Quên
										Mật Khẩu?</small>
								</a>
							</div>
					...
					<p class="text-center">
						<span>Bạn Chưa Có Tài Khoản</span> <a href="/com.tulamweb/regist">
