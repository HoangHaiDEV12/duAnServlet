			...
			<div class="card">
				<div class="card-body">
					...
					<div class="app-brand justify-content-center">
						<a href="/com.tulamweb/homepage" class="app-brand-link gap-2"> <span
                      ...
                      <g id="g-app-brand" stroke="none" stroke-width="1"
						...
						</span> <span class="app-brand-text demo text-body fw-bolder">Vớ Store</span>
						</a>
					</div>
					<!-- /Logo -->
					<h4 class="mb-2">Đăng kí tài khoản ngay</h4>

					<form id="formAuthentication" class="mb-3" action="regist"
						method="POST">
						<div class="mb-3">
							<label for="fullname" class="form-label">Tên đầy đủ </label> <input
								type="text" class="form-control" id="fullname" name="fullname"
								placeholder="Nhập tên đầy đủ của bạn" autofocus />
						</div>
						...
						<div class="mb-3">
							<label for="phonenum" class="form-label">Email</label> <input
					...
					<p class="text-center">
						<span>Bạn Đã Có Tài Khoản?</span> <a
							href="/com.tulamweb/login"> <span>Đăng Nhập Tại Đây</span>
						</a>
					</p>
				</div>
			</div>
